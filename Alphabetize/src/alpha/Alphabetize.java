...
//main method
	...
	public static void main(String[] args)
	{
		...
		for(int i = 0; i < 3; ++i)
		{
			if(!words.get(i).equals(wordsSort.get(i)))
			{
				isInOrder = false;
			}
		}
		...
		if(isInOrder)
		{
			JOptionPane.showMessageDialog(null, "Your words are in alphabetical order.");
		}
		else
		{
			JOptionPane.showMessageDialog(null, "Your words aren't in alphabetical order.");
		}
	}
