<<<<<<< HEAD:com/myriapps/java/WISPTNodeBuilder.java
/*
...

{
	...
	tipLabel_mouseClicked(MouseEvent me, JLabel clickedTipLabel, int index)
	{
		...
		{
			bufferedImage = WISPT.loadImage(this, true, "Images", this);
	...
	getSerializedWTNO()
	{
		...
		try 
		{
	         DefaultMutableTreeNode readNode = (DefaultMutableTreeNode)WISPT.loadSerializedObject(this, false, "temp", "node", "Serial File", "ser");
	...
	acceptChanges_actionPerformed(ActionEvent e)
	{
		...
		WISPT.saveSerializedObject(this, false, "temp", "node", "Serial File", "ser", nodeToSave);
...
>>>>>>> 03c2b20512d9bda5cb8dbf6f1160f54caaeee302:com/infowest/java/WISPTNodeBuilder.java
